...
import { AlertTriangle, Clock, Building, Eye, Plus, ShieldAlert, Loader2, AlertCircle, Filter } from 'lucide-react';
        ...
        {loading ? (
          ...
          >
            {filteredIncidents.map((inc) => (
              <motion.div key={inc._id} variants={itemVariants} className="bg-slate-800/40 backdrop-blur-xl rounded-[2rem] border border-white/10 shadow-xl shadow-black/20 hover:bg-slate-800/60 hover:border-white/20 transition-all duration-300 overflow-hidden group">
